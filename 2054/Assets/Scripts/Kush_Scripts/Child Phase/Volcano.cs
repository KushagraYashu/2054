...
public class Volcano : MonoBehaviour
{
    ...
    void ShowVolcanoMemory()
    {
        ...
        //we initially decided to have 2 states, fail and success, but were not able to implement fail memory animations due to time contraints. So, we only have 1 state now, Success.
        //if (IsPlaced)
        //{
